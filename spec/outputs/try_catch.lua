...
local _anon_func_15 = function(func, print)
	print(123)
	return func()
end
local _anon_func_13 = function(func, print, xpcall)
	return _anon_func_14(xpcall(_anon_func_15, function(e)
		print(e)
		return e
	end, func, print))
end
...
local _anon_func_16 = function(a, b, c, tb)
	return tb.f(a, b, c)
end
local _anon_func_17 = function(_arg_0, ...)
	local ok = _arg_0
	return ...
end
do
	...
	do
		x(function()
			...
			local f1
			f1 = function()
				return pcall(_anon_func_16, a, b, c, tb)
			end
		end)
	end
	do
		...
		f1 = function()
			do
				return _anon_func_17(pcall(function()
					return func()
				end))
			end
		end
